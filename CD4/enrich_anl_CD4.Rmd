...
setwd("/home/roger/data_immunotherapy/CD4/DEgenes/")

# List all files matching the pattern and sort them naturally
file_list <- mixedsort(list.files(pattern = "^branch[0-5]+\\.csv$"))
...
svg("/home/roger/data_immunotherapy/CD4/reactomeCD4.svg")
# Create the dot plot
...
output_file <- "/home/roger/data_immunotherapy/CD4/reactome_compareClusterResult.csv"
