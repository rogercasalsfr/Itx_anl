...
CD4pre <- LoadH5Seurat("/home/roger/Baixades/pre.h5seurat")
...
markers <- FindMarkers(subset_seurat_obj, ident.1=c("pre_Naive", ident.2=c("pre_Th17")))  # Find DE genes based on Wilcoxon test based on the different conditions.
...
write.csv(markers, file = "/home/roger/data_immunotherapy/CD4/DEgenes/branch2.csv", row.names = FALSE)
write.csv(cell_names, file = "/home/roger/data_immunotherapy/CD4/cell_names/branch2.csv", row.names = FALSE)
