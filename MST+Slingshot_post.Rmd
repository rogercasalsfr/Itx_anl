...
model_rooted2 <- modelprova2 %>% add_root(root_milestone_id = c("M3"))
...
totsCD4subsetpre <- order_cells(totsCD4subsetpre, reduction_method = 'UMAP', root_cells = colnames(totsCD4subsetpre[,clusters(totsCD4subsetpre) == "post_Naive"]))
